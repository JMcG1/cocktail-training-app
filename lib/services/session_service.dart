...
class SessionService {
  ...
  Future<JoinWithInviteResult> _joinWithFirebase({
    ...
    debugPrint(
      '[SessionService] Firebase join attempt for $trimmedEmail with role ${invite.role.name}.',
    );
  ...
  Future<String?> _signInLocally({
    ...
    debugPrint('[SessionService] Local sign-in attempt for $normalizedEmail.');
  ...
  Future<JoinWithInviteResult> _joinLocally({
    ...
    debugPrint(
      '[SessionService] Local join attempt for $trimmedEmail with role ${invite.role.name}.',
    );
